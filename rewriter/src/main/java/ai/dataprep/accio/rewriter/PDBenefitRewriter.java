...
public class PDBenefitRewriter {
    private static final Logger logger = LoggerFactory.getLogger(PDBenefitRewriter.class);
        ...
        // Join re-order
        {
            ...
            if (isPlain) {
                builder.addRuleCollection(ImmutableList.of(
                        ...
                        FedMultiJoinPDBenefitRule.Config.PLAIN.toRule()
                ));
            } else {
                builder.addRuleCollection(ImmutableList.of(
                        MultiJoinConditionRule.Config.DEFAULT.toRule(),
                        FedMultiJoinPDBenefitRule.Config.DEFAULT.toRule()
                ));
            }
