...
class AccioSession:
    def __init__(self, dbs, config_path=os.environ["ACCIO_CONFIG_PATH"] if "ACCIO_CONFIG_PATH" in os.environ else "./"):
    ...
    def rewrite(self, sql, stragegy=os.environ["ACCIO_REWRITE_STRATEGY"] if "ACCIO_REWRITE_STRATEGY" in os.environ else "benefit"):
